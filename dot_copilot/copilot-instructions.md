...
- GitHub identities are isolated: under /home/sachin/work use git-work/gh-work; under /home/sachin/repos use git-personal/gh-personal; outside those roots use plain git and never use either wrapper. Always use HTTPS for git-work (the wrapper uses the gh-work credential helper over HTTPS); never force/use SSH — SSH keys are not SSO-authorized for org repos.
